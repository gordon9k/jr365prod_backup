...
<div class="col-xs-12">
    ...
    <h5 class="amber-text text-darken-2"><b>{{ trans('label.category_new') }}</b></h5>
	...
	{{ Form::open(array('url' => $url,'route'=>'jobcategory.store','role'=>'form')) }}
	    ...
	    <div class="form-group has-error">
	        ...
	        {{ Form::text('name', Input::old('category'), array('class' => 'form-control')) }}
	    </div>
	    @else
		...
		@endif
	    {{ Form::submit('Create!', array('class' => 'btn btn-primary green')) }}
	{{ Form::close() }}
	</div>
</div>
</div>
